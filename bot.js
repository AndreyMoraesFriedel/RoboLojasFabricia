...
client.on('message', message => {
    ...
    //variavel para obter a mensagem enviada
    ...
    //Crediário da Loja
    if (str == '2' || /fazer crediário/i.test(str) || /fazer crediario/i.test(str) || /faço crediário/i.test(str) || /faço crediario/i.test(str)) {
